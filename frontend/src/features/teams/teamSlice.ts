...
const teamSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      ...
      .addCase(setActiveTeam.fulfilled, (state, action) => {
        // Update activeTeamId when team switch completes
        if (action.meta.arg) {
          state.activeTeamId = action.meta.arg;
          console.log('✅ [REDUX] activeTeamId updated to:', action.meta.arg);
        }
      });
  },
});
