...
router.get('/list/v2/:projectId', commonValidators.mongoIdParam('projectId'), tasks.getTaskListV3); // Use V3 logic for V2 for now
router.route('/list/columns/:projectId')
  .get(commonValidators.mongoIdParam('projectId'), tasks.getTaskListColumns)
  .put(commonValidators.mongoIdParam('projectId'), tasks.updateColumnVisibility);
